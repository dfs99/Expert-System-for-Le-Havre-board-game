...
(defrule COMIENZO_PARTIDA
    ...
    ;(watch facts)
    ;(watch instances)
    (dribble-on salidas/salida-prueba5Comprobar.txt)
    (printout t"=====================================================================================================" crlf)
    (printout t"                                PARTIDA JUEGO LE HAVRE" crlf)
    (printout t" fichero prueba: prueba5.clp" crlf)
...
(defrule MOSTRAR_RESULTADOS_PARTIDA
    (ronda_actual RONDA_EXTRA_FINAL)
    (object (is-a JUGADOR) (nombre ?nombre_jugador1) (deudas ?deudas_j1) (num_barcos ?num_barcos_j1) (riqueza ?valor_total_j1))
    (object (is-a JUGADOR) (nombre ?nombre_jugador2) (deudas ?deudas_j2) (num_barcos ?num_barcos_j2) (riqueza ?valor_total_j2))
    (test (neq ?nombre_jugador1 ?nombre_jugador2))
    ...
    ; Obtener valores estadísticas:
    ; J1
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso FRANCO) (cantidad ?cantidad_franco1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso PESCADO) (cantidad ?cantidad_pescado1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso MADERA) (cantidad ?cantidad_madera1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso ARCILLA) (cantidad ?cantidad_arcilla1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso HIERRO) (cantidad ?cantidad_hierro1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso GRANO) (cantidad ?cantidad_grano1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso GANADO) (cantidad ?cantidad_ganado1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso CARBON) (cantidad ?cantidad_carbon1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso PIEL) (cantidad ?cantidad_piel1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso PESCADO_AHUMADO) (cantidad ?cantidad_pescado_ahumado1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso CARBON_VEGETAL) (cantidad ?cantidad_carbon_vegetal1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso LADRILLOS) (cantidad ?cantidad_ladrillos1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso ACERO) (cantidad ?cantidad_acero1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso PAN) (cantidad ?cantidad_pan1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso CARNE) (cantidad ?cantidad_carne1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso COQUE) (cantidad ?cantidad_coque1))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador1) (recurso CUERO) (cantidad ?cantidad_cuero1))
    ; J2
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso FRANCO) (cantidad ?cantidad_franco2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso PESCADO) (cantidad ?cantidad_pescado2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso MADERA) (cantidad ?cantidad_madera2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso ARCILLA) (cantidad ?cantidad_arcilla2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso HIERRO) (cantidad ?cantidad_hierro2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso GRANO) (cantidad ?cantidad_grano2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso GANADO) (cantidad ?cantidad_ganado2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso CARBON) (cantidad ?cantidad_carbon2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso PIEL) (cantidad ?cantidad_piel2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso PESCADO_AHUMADO) (cantidad ?cantidad_pescado_ahumado2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso CARBON_VEGETAL) (cantidad ?cantidad_carbon_vegetal2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso LADRILLOS) (cantidad ?cantidad_ladrillos2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso ACERO) (cantidad ?cantidad_acero2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso PAN) (cantidad ?cantidad_pan2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso CARNE) (cantidad ?cantidad_carne2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso COQUE) (cantidad ?cantidad_coque2))
    (object (is-a PARTICIPANTE_TIENE_RECURSO) (nombre_jugador ?nombre_jugador2) (recurso CUERO) (cantidad ?cantidad_cuero2))
    =>
    ...
    (printout t"=====================================================================================================" crlf)
    (printout t"+---------------------------------------------------------------------------------------------------+" crlf)
    (printout t"|                                           ESTADÍSTICAS                                            |" crlf)
    (printout t"+---------------------------------------------------------------------------------------------------+" crlf)
    (printout t" Valores Globales Jugador" crlf)
    (printout t"    Jugador: "?nombre_jugador1 crlf)
    (printout t"    Numero barcos: "?num_barcos_j1 crlf)
    (printout t"    Numero deudas: "?deudas_j1 crlf) 
    (printout t"    Riqueza total [edificios + barcos]: "?valor_total_j1 crlf)
    (printout t" Cantidades recurso jugador:" crlf)
    (printout t"    Francos: " ?cantidad_franco1 crlf)
    (printout t"    Pescado: " ?cantidad_pescado1 crlf)
    (printout t"    Madera: " ?cantidad_madera1 crlf)
    (printout t"    Arcilla: " ?cantidad_arcilla1 crlf)
    (printout t"    Hierro: " ?cantidad_hierro1 crlf)
    (printout t"    Grano: " ?cantidad_grano1 crlf)
    (printout t"    Ganado: " ?cantidad_ganado1 crlf)
    (printout t"    Carbón: " ?cantidad_carbon1 crlf)
    (printout t"    Piel: " ?cantidad_piel1 crlf)
    (printout t"    Pescado Ahumado: " ?cantidad_pescado_ahumado1 crlf)
    (printout t"    Carbón Vegetal: " ?cantidad_carbon_vegetal1 crlf)
    (printout t"    Ladrillos: " ?cantidad_ladrillos1 crlf)
    (printout t"    Acero: " ?cantidad_acero1 crlf)
    (printout t"    Pan: " ?cantidad_pan1 crlf)
    (printout t"    Carne: " ?cantidad_carne1 crlf)
    (printout t"    Coque: " ?cantidad_coque1 crlf)
    (printout t"    Cuero: " ?cantidad_cuero1 crlf)
    (printout t"+---------------------------------------------------------------------------------------------------+" crlf)
    (printout t"+---------------------------------------------------------------------------------------------------+" crlf)
    (printout t" Valores Globales Jugador" crlf)
    (printout t"    Jugador: "?nombre_jugador2 crlf)
    (printout t"    Numero barcos: "?num_barcos_j2 crlf)
    (printout t"    Numero deudas: "?deudas_j2 crlf) 
    (printout t"    Riqueza total [edificios + barcos]: "?valor_total_j2 crlf)
    (printout t" Cantidades recurso jugador:" crlf)
    (printout t"    Francos: " ?cantidad_franco2 crlf)
    (printout t"    Pescado: " ?cantidad_pescado2 crlf)
    (printout t"    Madera: " ?cantidad_madera2 crlf)
    (printout t"    Arcilla: " ?cantidad_arcilla2 crlf)
    (printout t"    Hierro: " ?cantidad_hierro2 crlf)
    (printout t"    Grano: " ?cantidad_grano2 crlf)
    (printout t"    Ganado: " ?cantidad_ganado2 crlf)
    (printout t"    Carbón: " ?cantidad_carbon2 crlf)
    (printout t"    Piel: " ?cantidad_piel2 crlf)
    (printout t"    Pescado Ahumado: " ?cantidad_pescado_ahumado2 crlf)
    (printout t"    Carbón Vegetal: " ?cantidad_carbon_vegetal2 crlf)
    (printout t"    Ladrillos: " ?cantidad_ladrillos2 crlf)
    (printout t"    Acero: " ?cantidad_acero2 crlf)
    (printout t"    Pan: " ?cantidad_pan2 crlf)
    (printout t"    Carne: " ?cantidad_carne2 crlf)
    (printout t"    Coque: " ?cantidad_coque2 crlf)
    (printout t"    Cuero: " ?cantidad_cuero2 crlf)
    (printout t"+---------------------------------------------------------------------------------------------------+" crlf)
    (dribble-off)
    (halt)
)
...
(defrule CAMBIAR_DECISION_PAGO_COMIDA_ENTRAR_EDIFICIOS
    ...
    (printout t"El jugador: <"?nombre_jugador"> ha cambiado su decisión de pago de comida del recurso: <"?recurso"> al recurso <"?otro_recurso"> para entrar a edificios." crlf)
)
...
(defrule RELLENAR_DESEO_COMPAÑIA_NAVIERA_SIN_COSTE
    ; es decir, le pertenece la compañia naviera al jugador.
    (object (is-a PARTICIPANTE_TIENE_CARTA) (nombre_jugador ?nombre_jugador) (nombre_carta "COMPAÑIA NAVIERA"))
    ; es la ronda extra final.
    (ronda_actual RONDA_EXTRA_FINAL)
    (turno ?nombre_jugador)
...
; Reglas Implementadas que funcionan correctamente pero no han sido implementadas en la estrategia.
; Por ende, se dejan como anexo del fichero comentadas para evitar confusiones.
...
; Regla 37 : NO USAMOS ENERGIA: OMITIR
...
; Regla 39: NO USAMOS ENERGIA: OMITIR
...
; Regla 40: NO USAMOS ENERGIA: OMITIR
