...
(definstances situacion_inicial
    ...
    ; == DIEGO
    (francos_diego of JUGADOR_TIENE_RECURSO (nombre_jugador "DIEGO") (recurso FRANCO)(cantidad 5))
    ...
    ; == RICARDO
    (francos_ricardo of JUGADOR_TIENE_RECURSO (nombre_jugador "RICARDO") (recurso FRANCO)(cantidad 5))
